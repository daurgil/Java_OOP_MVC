...
//        pagina.initLinkBox();
        ...
        jLabel3.setText(String.valueOf(singleton_user.admin.size()));
        ...
        for(int i=0;i<=singleton_user.admin.size()-1;i++) {
            myWords.add(singleton_user.admin.get(i).getName());
        }
...
//        ((miniSimpleTableModel_actor)TABLA.getModel()).filtrar();
//    } 
