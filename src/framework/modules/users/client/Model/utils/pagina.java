...
public class pagina {
    ...
    public static void inicializa() {
        ...
        rowCount = ((miniSimpleTableModel_client)client_table.TABLA.getModel()).getRowCount();
        ...
        client_table.jPanel4.setLayout(new BorderLayout());
        client_table.jPanel4.add(pagina.box);
                    
    }
    public static void initLinkBox() {
        
                    client_controler.sorter.setRowFilter(new RowFilter<TableModel, Integer>() {
        ...
        if(  (rowCount<=itemsPerPage) && (rowCount>0)  ){ //caben todos los datos en la misma página
                ...
                client_table.primero.setEnabled(false);
                client_table.ANTERIOR.setEnabled(false);
                client_table.SIGUIENTE.setEnabled(false);
                client_table.ultimo.setEnabled(false);
                client_table.CAJA.setText("");
            ...
            box.repaint();
                    ...
                    client_table.primero.setEnabled(currentPageIndex>1);
                    client_table.ANTERIOR.setEnabled(currentPageIndex>1);
                    client_table.SIGUIENTE.setEnabled(currentPageIndex<maxPageIndex);
                    client_table.ultimo.setEnabled(currentPageIndex<maxPageIndex);
                    client_table.CAJA.setText(Integer.toString(currentPageIndex) + String.format(" / %d", maxPageIndex));
